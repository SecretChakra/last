            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        ...
                        <h1>Benvenuti nel nostro centro di documentazione tecnica, progettato per fornirvi tutte le risorse necessarie post-vendita per utilizzare al meglio i nostri prodotti.</h1>
                <main class="mt-6">
